  ...
  return (
    <html lang="vi" className="dark">
      <head>
        <meta
          property="og:image"
          content={`${getBaseUrl()}/images/thumb.jpg`}
        />
        ...
        <meta
          property="og:logo"
          content={`${getBaseUrl()}/images/kaoruhana.jpg`}
        />
        <meta
          name="twitter:image"
          content={`${getBaseUrl()}/images/thumb.jpg`}
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Noto+Sans:wght@400;500;600;700;800&display=swap&subset=latin,vietnamese"
          rel="stylesheet"
        />
      </head>
