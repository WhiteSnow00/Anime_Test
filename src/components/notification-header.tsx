  ...
  return (
    <div className={cn("w-full relative z-10", className)}>
      <div className={cn(
        ...
        {/* Updated container to match video player width alignment */}
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-0 my-2 sm:my-4">
            ...
            <div className="relative p-3 sm:p-5">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        {/* Fixed timing text to prevent bad line breaks */}
                  ...
                  {/* Schedule info - improved mobile layout */}
                  <div className="mt-4">
